...
import org.sample.shop.common.db.queryrunner.statementfactory.StatementFactory;
...
public interface Statements {
    ...
    // cart
    String cart_addItem = StatementFactory.getStatement("#cart_addItem");
    String cart_removeItem = StatementFactory.getStatement("#cart_removeItem");
    String cart_removeAll = StatementFactory.getStatement("#cart_removeAll");
    String cart_getByUid = StatementFactory.getStatement("#cart_getByUid");
    String cart_getPreOrder = StatementFactory.getStatement("#cart_getPreOrder");
    String cart_getSum = StatementFactory.getStatement("#cart_getSum");
}
